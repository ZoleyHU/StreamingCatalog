...
const Card: React.FC<Props> = ({id, show, country}: Props): JSX.Element => {
  return (
    <Link to={`/show/${country}/${show.imdbId}`} className='m-auto w-60 h-fit flex flex-col items-center text-center p-3 rounded-xl overflow-hidden shadow-lg shadow-slate-700 bg-white'>
